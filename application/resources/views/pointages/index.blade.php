        ...
        <form method="GET" action="{{ route('pointages.global') }}" class="mb-4 p-4 rounded shadow-sm bg-light border">
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <select name="site_id" id="site_id" class="form-control filtre-select"
                        {{ $filtreFixe ? 'disabled' : '' }}>
                ...
                <div class="col-md-3">
                    ...
                    <select name="projet_id" id="projet_id" class="form-control filtre-select"
                        {{ $filtreFixe ? 'disabled' : '' }}>
                    ...
                    <select name="week" id="week" class="form-control filtre-select">
                        @foreach ($semaines as $semaine)
                            <option value="{{ $semaine['numero'] }}"
                                {{ $selectedWeek == $semaine['numero'] ? 'selected' : '' }}>
                                {{ $semaine['label'] }}
                            </option>
                        @endforeach
                    </select>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @foreach ($dates as $date)
                                                            @php
                                                                $pointage =
                                                                    $user &&
                                                                    isset($pointagesParAgentDate[$user->id][$date])
                                                                        ? $pointagesParAgentDate[$user->id][$date]
                                                                        : null;

                                                                $heureDebutPl =
                                                                    $pointage['heure_debut_planning'] ?? null;
                                                                ...
                                                                $formatHeure = function ($h) {
                                                                    return $h
                                                                        ? \Illuminate\Support\Carbon::parse($h)->format(
                                                                            'H:i',
                                                                        )
                                                                        : '-';
                                                                };
                                                                ...
                                                                $retard =
                                                                    $heureDebutPt &&
                                                                    $heureDebutPl &&
                                                                    $heureDebutPt > $heureDebutPl;
                                                                $partiTot =
                                                                    $heureFinPt &&
                                                                    $heureFinPl &&
                                                                    $heureFinPt < $heureFinPl;
                                                            @endphp
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                @if ($partiTot)
                                                                    <span class="badge bg-warning text-dark ms-1"
                                                                        title="Parti tôt">Parti tôt</span>
                                                                @endif
                                                            </td>
                                                        @endforeach
