    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="POST" class="row g-3" action="{{ route('agents.store') }}" enctype="multipart/form-data">
                        @csrf

                        <div class="col-md-4">
                            <label for="workday_id" class="form-label">Workday ID *</label>
                            <input id="workday_id" type="number" class="form-control" required name="workday_id" value="">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="workday_id_manager" type="number" class="form-control" required name="workday_id_manager" value="">
                        </div>
